...
** https://docs.netapp.com/us-en/cloud-manager-azure-netapp-files/task-manage-anf.html["设置和发现 Azure NetApp Files"^]
...
** 选择 S3 存储类。 link:reference-requirements.html#storage-classes["查看支持的存储类。"]。
+
